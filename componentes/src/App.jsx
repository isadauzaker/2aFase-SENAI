...
function App() {
  ...
  return (
    <>
      ...
      <h2>Coisas legais para facilitar sua vida</h2>
      <p>comando para o emmet da ul: ul>li*6</p>
     ...
     <ul>
      ...
      <li>Atalho: alt + shift + ↕ copia a linha atual ou bloco selecionado</li>
      <li>Atalho: ctrl + j ou ctrl + ' abre/fecha o terminal</li>
     </ul>
     <p>Para esfregar vários cursores pela tela (digitar várias coisas ao mesmo tempo): Clica com a rodinha e esfrega ela pela tela.</p>
